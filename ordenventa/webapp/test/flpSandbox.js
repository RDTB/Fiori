		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nsordenventa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsordenventa-display": {
								"semanticObject": "nsordenventa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.ordenventa",
									"url": sap.ui.require.toUrl("ns/ordenventa")
								}
							}
						}
					}
